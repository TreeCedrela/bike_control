...
public class MapActivity extends AppCompatActivity implements AMapLocationListener, LocationSource, DistanceSearch.OnDistanceSearchListener {
...
//        });
        ...
        continueLastTimeBt.setOnClickListener(v -> {
            Intent intent = new Intent(MapActivity.this, continueActivity.class);
            startActivity(intent);
        });
